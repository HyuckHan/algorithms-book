...
![$j=0,1,2$ 계산: $shift[T]=4,\ shift[I]=3,\ shift[G]=2$.](../figures/09-string-matching/15-tiger-shift-table-step1.svg){fig-alt="TIGER shift table에서 T=4,I=3,G=2가 계산되어 채워지고 E,R은 아직 물음표로 미확정인 상태" width="55%"}

## 2단계

![$j=3$(loop 마지막) 계산: $shift[E]=1$ 추가. 나머지 문자의 초기화값 $shift[\text{other}]=m=5$도 함께 표시.](../figures/09-string-matching/15-tiger-shift-table-step2.svg){fig-alt="TIGER shift table에 shift[E]=1이 추가되고 other=5 초기화값 배지가 함께 표시된 상태" width="55%"}
