...
![match at 0 뒤 $j\gets lps[2]=2$로 fallback해 overlap을 포함한 matches $[0,1,2]$를 모두 찾는 2단계.](../figures/09-string-matching/13-kmp-overlapping-match-step2.svg){fig-alt="AAAAA에서 AAA 패턴이 match 0 뒤 overlap을 유지해 matches 0,1,2를 모두 찾는 2단계 트레이스의 마지막 상태" width="55%"}
