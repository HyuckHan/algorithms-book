...
![정수부를 취해 최종 index를 얻는다: $\lfloor5.861\rfloor=5$.](../figures/07-hash-tables/04-multiplication-trace-step4.svg){fig-alt="⌊5.861⌋=5 상자가 강조된 상태" width="90%"}
:::
...
![resolution policy가 29의 실제 위치를 정한다.](../figures/07-hash-tables/07-insert-29-collision-trace-step3.svg){fig-alt="slot 3이 16으로 점유된 상태에서 29를 삽입하려다 충돌이 표시되고 resolution policy가 실제 위치를 정한다는 콜아웃이 붙은 상태" width="75%"}
:::
