...
![SUCCESSOR 두 case: 15는 right subtree(18 아래)의 minimum인 17이 successor이고, 4는 위로 올라가 처음 left-turn 경계인 6이 successor다.](../figures/06-search-trees/15-successor-cases.svg){fig-alt="15와 17이 강조된 case1 트리와 나란히 4와 6이 강조된 case2 설명이 함께 표시된 다이어그램" width="25%"}
![Case 2 보조 그림: 4에서 부모 3, 조부모 6으로 올라가며 처음 left child였던 지점(3)의 부모(6)가 successor.](../figures/06-search-trees/16-successor-case2-ancestor-chain.svg){fig-alt="6,3,4 세 노드가 위로 올라가는 화살표로 연결된 보조 다이어그램" width="15%"}
