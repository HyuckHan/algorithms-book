...
![입력 크기가 커질수록 성장률(빨간 곡선)이 상수 차이를 압도한다는 개념도.](../figures/01-introduction/02-scale-growth.svg){fig-alt="linear로 표시된 파란 곡선과 quadratic으로 표시된 주황 곡선이 n이 커질수록 벌어지는 개념도" width="45%"}
