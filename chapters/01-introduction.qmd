...
![Maximum 추적: 처리한 prefix의 최댓값을 $v$로 유지한다.](../figures/01-introduction/06-maximum-trace.svg){fig-alt="7,12,3,15,8 다섯 칸 배열 아래 처리한 prefix를 표시하는 중괄호가 그려진 다이어그램" width="55%"}
