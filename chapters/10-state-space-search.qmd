...
![Subset Sum trace: i=0,s=0,r=18 → include 3 → include 4,5는 s=12>9로 prune → exclude 후 {3,6} 확정 → 다른 branch {4,5}도 확정.](../figures/10-state-space-search/09-subset-sum-trace-step5.svg){fig-alt="i=0에서 시작해 3을 포함한 뒤 4,5를 포함하면 overshoot으로 prune되고 결국 두 solution을 모두 찾는 5단계 트레이스의 마지막 상태" width="25%"}
