...
![Knapsack best-first trace: root UB115 → A 포함/제외 → B 포함/제외 → UB가 가장 큰 AB를 먼저 꺼내지만 C를 넣으면 무게 17로 용량을 넘어 폐기되고 → exclude-B에서 C를 포함해 w12,p90 확정 → UB가 90 이하인 ¬A(82)와 AB¬C(80)를 prune → PQ empty, optimum 90.](../figures/10-state-space-search/13-knapsack-best-first-trace-step8.svg){fig-alt="state box에 PQ empty: optimum 90이, note에 optimal weight 12, profit 90이 표시된 화면" width="30%"}
