...
![등차수열 trace: choose 1 → choose 3(d=2) → try 4는 차이 2,1로 prune → choose 5,7으로 [1,3,5,7] 완성 → INC=4.](../figures/10-state-space-search/11-arithmetic-progression-trace-step5.svg){fig-alt="1을 선택하고 3을 선택해 차이 2를 고정한 뒤 4를 시도하다 차이가 달라 prune하고 5,7을 이어 선택해 길이 4의 등차수열을 완성하는 5단계 트레이스의 마지막 상태" width="30%"}
