...
![initialize.](../figures/03-sorting/14-counting-sort-trace-step1.svg){fig-alt="A=4,1,3,4,3 배열에서 C 배열이 모두 0으로 초기화된 상태" width="60%"}

## 2단계

![frequency count.](../figures/03-sorting/14-counting-sort-trace-step2.svg){fig-alt="C 배열이 각 key의 빈도 0,1,0,2,2로 채워진 상태" width="60%"}

## 3단계

![cumulative prefix.](../figures/03-sorting/14-counting-sort-trace-step3.svg){fig-alt="C 배열이 누적합 0,1,1,3,5로 바뀐 상태" width="60%"}

## 4단계

![stable placement.](../figures/03-sorting/14-counting-sort-trace-step4.svg){fig-alt="B=1,3,3,4,4로 stable하게 배치된 마지막 상태" width="60%"}
:::
