...
![29와 10: 역전이므로 swap.](../figures/03-sorting/04-bubble-trace-step1.svg){fig-alt="29,10,14,37,13 배열에서 29와 10이 강조된 1단계 상태" width="40%"}

## 2단계

![29와 14: swap.](../figures/03-sorting/04-bubble-trace-step2.svg){fig-alt="10,29,14,37,13 배열에서 29와 14가 강조된 상태" width="40%"}

## 3단계

![37과 13: swap.](../figures/03-sorting/04-bubble-trace-step3.svg){fig-alt="10,14,29,37,13 배열에서 37과 13이 강조된 상태" width="40%"}

## 4단계

![첫 pass 종료: 최댓값 37 확정.](../figures/03-sorting/04-bubble-trace-step4.svg){fig-alt="10,14,29,13,37 배열에서 37이 오른쪽 끝에 확정된 마지막 상태" width="40%"}
:::
...
![pivot=15, scan 시작.](../figures/03-sorting/08-quick-partition-trace-step1.svg){fig-alt="10개 원소 배열에서 마지막 원소 15가 pivot으로 표시된 1단계 상태" width="65%"}

## 2단계

![8은 왼쪽 경계 안으로.](../figures/03-sorting/08-quick-partition-trace-step2.svg){fig-alt="8이 왼쪽 경계 index 1 안으로 들어온 상태" width="65%"}

## 3단계

![11과 3까지 왼쪽으로.](../figures/03-sorting/08-quick-partition-trace-step3.svg){fig-alt="11과 3이 왼쪽 경계 index 3까지 들어온 상태" width="65%"}

## 4단계

![pivot은 index 4에서 최종 위치.](../figures/03-sorting/08-quick-partition-trace-step4.svg){fig-alt="pivot 15가 index 4에 최종 위치하고 왼쪽 partition이 완료된 상태를 중괄호로 표시한 마지막 상태" width="65%"}
:::
