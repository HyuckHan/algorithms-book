...
![out=[]에서 R의 5부터 선택.](../figures/03-sorting/07-merge-pointers-step1.svg){fig-alt="L과 R 두 배열 위에서 R의 5가 선택되어 out 배열의 첫 칸에 놓이는 1단계 상태" width="55%"}

## 2단계

![out=[5,8] 다음 L의 10을 선택.](../figures/03-sorting/07-merge-pointers-step2.svg){fig-alt="out에 5,8이 채워지고 L의 10이 강조되어 다음으로 선택되는 상태" width="55%"}

## 3단계

![out=[5,8,10,13] 다음 L의 14를 선택.](../figures/03-sorting/07-merge-pointers-step3.svg){fig-alt="out에 5,8,10,13이 채워지고 L의 14가 강조되어 다음으로 선택되는 상태" width="55%"}

## 4단계

![한쪽이 비면 나머지 suffix를 그대로 붙인다: out=[5,8,10,13,14,21,29,37].](../figures/03-sorting/07-merge-pointers-step4.svg){fig-alt="out 배열이 5,8,10,13,14,21,29,37로 완전히 채워진 마지막 상태" width="55%"}
:::
