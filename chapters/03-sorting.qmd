...
![Selection Sort 4단계 추적. 주황은 이번 pass에서 선택된 최댓값, 회색은 확정된 sorted suffix다.](../figures/03-sorting/03-selection-trace-step1.svg){fig-alt="5칸 배열 29,10,14,37,13에서 37이 주황으로 강조된 1단계 상태" width="40%"}
![](../figures/03-sorting/03-selection-trace-step5.svg){fig-alt="10,13,14,29,37로 완전히 정렬되어 모두 회색으로 표시된 마지막 상태" width="40%"}
