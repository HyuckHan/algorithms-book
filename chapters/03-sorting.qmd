...
![최댓값 37을 찾는다: 29, 10, 14, 37, 13.](../figures/03-sorting/03-selection-trace-step1.svg){fig-alt="5칸 배열 29,10,14,37,13에서 37이 주황으로 강조된 1단계 상태" width="40%"}
...
![13과 10을 swap하여 정렬 완료: 10, 13, 14, 29, 37.](../figures/03-sorting/03-selection-trace-step5.svg){fig-alt="10,13,14,29,37로 완전히 정렬되어 모두 회색으로 표시된 마지막 상태" width="40%"}
:::
...
![29와 10 비교: 역전이므로 swap.](../figures/03-sorting/04-bubble-trace-step1.svg){fig-alt="29,10,14,37,13 배열에서 29와 10이 강조된 1단계 상태" width="40%"}
...
![첫 pass 종료: 최댓값 37 확정.](../figures/03-sorting/04-bubble-trace-step5.svg){fig-alt="10,14,29,13,37 배열에서 37이 오른쪽 끝에 확정된 마지막 상태" width="40%"}
:::
...
![key를 꺼내 hole 생성.](../figures/03-sorting/05-insertion-trace-step1.svg){fig-alt="10,14,29,13,37 배열에서 index 4에 hole이 생기고 key=13인 1단계 상태" width="40%"}
...
![다음 반복 전에 정렬된 prefix 확인.](../figures/03-sorting/05-insertion-trace-step5.svg){fig-alt="10,13,14,29,37로 정렬된 prefix가 확인된 마지막 상태" width="40%"}
:::
...
![out=[]에서 R의 5 선택.](../figures/03-sorting/07-merge-pointers-step1.svg){fig-alt="L과 R 두 배열 위에서 R의 5가 강조되어 out의 첫 칸에 놓이는 1단계 상태" width="55%"}
...
![완료: out=[5,8,10,13,14,21,29,37].](../figures/03-sorting/07-merge-pointers-step8.svg){fig-alt="out 배열이 5,8,10,13,14,21,29,37로 완전히 채워진 마지막 상태" width="55%"}
:::
...
![$j=1$: 31과 pivot 비교 → $31>15$, 비교만(지나감).](../figures/03-sorting/08-quick-partition-trace-step1.svg){fig-alt="10개 원소 배열에서 마지막 원소 15가 pivot으로, 31이 빗금 표시로 강조된 1단계 상태" width="65%"}
...
![pivot을 index 4와 swap: partition 완료.](../figures/03-sorting/08-quick-partition-trace-step10.svg){fig-alt="pivot 15가 index 4에 최종 위치하고 왼쪽 partition이 완료된 상태를 중괄호로 표시한 마지막 상태" width="65%"}
:::
...
![4와 큰 child 14 비교.](../figures/03-sorting/11-heapify-trace-step1.svg){fig-alt="index 1의 4와 큰 child 14가 비교되는 1단계 array/tree 상태" width="55%"}
...
![index 4에서 두 child 2, 1보다 크므로 종료.](../figures/03-sorting/11-heapify-trace-step4.svg){fig-alt="index 4에서 멈추는 마지막 상태" width="55%"}
:::
...
![$i=5$: leaf의 parent부터 시작.](../figures/03-sorting/12-build-heap-trace-step1.svg){fig-alt="i=5에서 HEAPIFY를 시작하는 1단계 array/tree 상태" width="55%"}
...
![$i=1$ 완료: max-heap.](../figures/03-sorting/12-build-heap-trace-step5.svg){fig-alt="i=1의 HEAPIFY까지 끝나 16,14,10,8,7,9,3,2,4,1로 완성된 max-heap 마지막 상태" width="55%"}
:::
...
![max-heap 준비.](../figures/03-sorting/13-heapsort-trace-step1.svg){fig-alt="16,14,10,8,7,9,3,2,4,1로 이루어진 max-heap 1단계 상태" width="55%"}
...
![1. initialize.](../figures/03-sorting/14-counting-sort-trace-step1.svg){fig-alt="A=4,1,3,4,3 배열에서 C 배열이 모두 0으로 초기화된 1단계 상태" width="60%"}
...
![ones 결과.](../figures/03-sorting/15-radix-trace-step1.svg){fig-alt="170,90,802,2,24,45,75,66 배열이 ones 자리 기준으로 재배열된 1단계 상태" width="60%"}
...
![hundreds 결과.](../figures/03-sorting/15-radix-trace-step3.svg){fig-alt="2,24,45,66,75,90,170,802로 완전히 정렬된 마지막 상태" width="60%"}
:::
