...
![새 key를 꺼내고 큰 원소를 한 칸씩 shift하여 생긴 hole에 넣는다.](../figures/03-sorting/05-insertion-cards.svg){fig-alt="10,14,29,13 네 장의 카드 중 13을 꺼내 앞쪽으로 삽입하는 화살표가 그려진 다이어그램" width="40%"}
