// New: no canonical source (lecture-notes/code/lecture08/c/shortest_paths.c
// only has Dijkstra/Bellman-Ford). Reuses graph_topological_kahn verbatim
// and adds the Relax loop the DAGShortestPaths pseudocode describes.
#include "graph.h"
#include <stdlib.h>
