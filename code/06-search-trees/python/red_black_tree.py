...
lecture-notes/code/lecture06/java/RedBlackTree.java와 같은 정책·예제 입력을 쓴다."""
...
if __name__ == "__main__":
    ...
    print("root:", t.root.key, "B" if t.root.color == BLACK else "R")
    t.delete(31)
    t.delete(41)
    t.delete(8)
    print("delete inorder:", ",".join(str(k) for k in t.inorder()))
