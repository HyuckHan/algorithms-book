...
/** lecture-notes/code/lecture06/java/RedBlackTree.java와 동일(verbatim).
...
public final class RedBlackTree {
    ...
    public static void main(String[] args) {
        ...
        for (int k : new int[] {41, 38, 31, 12, 19, 8}) t.insert(k);
        System.out.println("inorder: " + join(t.inorder()));
        System.out.println("root: " + t.root.key + " " + (t.root.color == BLACK ? "B" : "R"));
        t.delete(31);
        t.delete(41);
        t.delete(8);
        System.out.println("delete inorder: " + join(t.inorder()));
    }
}
